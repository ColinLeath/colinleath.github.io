...
if (standardstyling) document.write('<br/>');
if (standardstyling) document.write('<a href="' + json.feed.entry[1].link[1].href + '">Subscribe to comment feed</a> <a href="http://colinleath.googlepages.com/showrecentcomments2.js">src</a>');
if (!standardstyling) document.write('</div>');}
